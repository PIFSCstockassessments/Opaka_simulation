...
for(i in 1:length(scen_dirs)){
    dir_copy(file.path(main.dir, "models", paste0("opaka-om-", nyears_fwd)), scen_dirs[i])
    dir_copy(file.path(main.dir, "models", paste0("opaka-em-", nyears_fwd)), scen_dirs[i])
}
...
target_dirs <- list.dirs(file.path(main.dir, paste(scen, nyears_fwd, "yrfwd", sep = "_")), recursive = F)
writeLines(target_dirs, file.path(main.dir, paste(scen, nyears_fwd, "yrfwd", sep = "_"), "target_dirs.txt"))
shell(paste0("powershell cd ", main.dir, ";tar -czf upload.SQ_15_yrsfwd.tar.gz SQ_15_yrfwd/"))
...
file.path(main.dir, "SQpoorrec_15_yrfwd", "8", "om"),
file.path(main.dir, "SQpoorrec_15_yrfwd", "8", "em"),
file.path(main.dir, "SQpoorrec_15_yrfwd", "9", "om"),
file.path(main.dir, "SQpoorrec_15_yrfwd", "9", "em"),
file.path(main.dir, "SQpoorrec_15_yrfwd", "10", "om"),
file.path(main.dir, "SQpoorrec_15_yrfwd", "10", "em")
