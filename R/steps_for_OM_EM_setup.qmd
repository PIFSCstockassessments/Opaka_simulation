...
get_results_all(
    overwrite_files = T,
    user_scenarios =  all_scenario_names[c(1,2,7,8)],
    filename_prefix = "FRS_HRF_scens"
)   
get_fits_all(
    overwrite_files = T,
    user_scenarios = all_scenario_names[c(1,2,7,8)], #all_scenario_names,
    filename_prefix = "FRS_HRF_scens"
)
...
file.path(main.dir, "HRF_SQ_test_", "1", "om"),
file.path(main.dir, "HRF_SQ_test_", "1", "em")
))
...
SSplotComparisons(reps_sum, models = c(1,2), legendlabels = c("om", "em"), uncertainty = F)
