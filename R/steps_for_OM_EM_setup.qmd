...
for(i in 1:length(scen_dirs)){
    fs::dir_copy(file.path(main.dir, "models", paste0("opaka-om-", nyears_fwd, "-R0_trend")), scen_dirs[i]) #"-FRS-only" #, "-selex"
...
get_results_all(
    overwrite_files = T,
    user_scenarios =  all_scenario_names[c(3)],
    filename_prefix = "LRF_SQ"
)   
get_fits_all(
    overwrite_files = T,
...
rep <- SS_output(file.path(main.dir, "HRF_test/2_d/em"))
SS_plots(rep)
reps <- SSgetoutput(dirvec = c(
file.path(main.dir, "HRF_test", "10", "om"),
file.path(main.dir, "HRF_test", "10", "em")
))
...
SSplotComparisons(reps_sum, legendlabels = c("om", "em"))
