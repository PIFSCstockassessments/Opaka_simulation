...
SS_writedat_3.30(dat_samp, outfile = file.path(new_EM_dir, "ss3.dat"), overwrite = TRUE)
#######
...
likes <- profile(
  ...
  string = "SR_LN",
  profilevec = r0_vec[3:8],
  exe = "ss",
  verbose = FALSE,
  extras="-nohess -nox"
)

profile_mods <- SSgetoutput(dirvec = like_dir, keyvec = 1:5)
