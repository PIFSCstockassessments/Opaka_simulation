...
for(i in 1:length(scen_dirs)){
    fs::dir_copy(file.path(main.dir, "models", paste0("opaka-om-", nyears_fwd, "-FRS-only")), scen_dirs[i]) #"-FRS-only" #, "-selex" , "-R0_trend"
...
file.path(main.dir, "new_poorrec_test", "2", "om"),
file.path(main.dir, "new_poorrec_test", "2", "em")
